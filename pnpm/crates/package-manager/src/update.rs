use crate::{
    ...
    manifest_spec_bumps::{ManifestSpecBumps, split_registry_alias},
...
fn read_catalog_ctx(
    ...
    let workspace_dir_opt =
        crate::workspace_discovery::discovered_workspace_dir(config, &manifest_dir)
            .map_err(UpdateError::FindWorkspaceDir)?;
